				...
				<div class="col-sm-4">
					<select id="tree" name="NEW_FIB_TREE" class="form-control">
						<?php foreach (Tree::getAll() as $tree): ?>
							<?php if ($tree->getTreeId() == $this->tree()->getTreeId()): ?>
							...
							<form class="form-inline" method="post" name="form2">
								...
								<div class="form-group">
									...
									<label class="checkbox-inline">
										<?= FunctionsEdit::checkbox('soundex_std') . I18N::translate('Russell') ?>
									</label>
									<label class="checkbox-inline">
										<?= FunctionsEdit::checkbox('soudex_dm') . I18N::translate('Daitch-Mokotoff') ?>
									</label>
								...
								<table id="search-result-table" class="table" style="display: none">
									...
									<tbody>
										<tr>
											...
											<!-- ACCESS LEVEL -->
											<td>
												<?= FunctionsEdit::editFieldAccessLevel('access_level', 2, 'class="form-control"') ?>
											</td>
											<!-- ADD BUTTON -->
											<td>
